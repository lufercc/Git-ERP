 ...
 */
public class BasicInfoEmployee extends OdooObject {
    ...
    public boolean matchWith(boolean shouldContain, OdooObject inputData) {
        BasicInfoEmployee uiData = (BasicInfoEmployee)inputData;
        if (this.fullName != null){
            if (this.fullName.equals(uiData.fullName) != shouldContain) {
