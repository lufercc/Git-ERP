 ...
 */
public class PopupSearch extends PortalUIElement{

    @FindBy(css = "div.oe_popup_search div.oe_searchview_clear")
    protected WebElement clearFilter;

    @FindBy(css = "div.oe_popup_search div.oe_searchview_unfold_drawer")
    protected WebElement searchUnfold;

    @FindBy(css = "div.oe_popup_search div.oe_searchview_advanced > h4")
    protected WebElement openAdvancedSearch;

    @FindBy(css = "div.oe_popup_search  div.oe_searchview_advanced")
    protected WebElement advancedSearchContainer;

    @FindBy(css = " div.oe_popup_search select.searchview_extended_prop_field")
    protected WebElement attributeSelect;

    @FindBy(css = "div.oe_popup_search input.field_char")
    protected WebElement valueInput;

    @FindBy(css = "div.oe_popup_search button.oe_apply")
