...
Feature: Employee
  ...
  Scenario Outline: Verify that employee fields are edited with admin role
    ...
    And I create an employee with required fields
      ...
      | auto      | edit<number> | 6454215  | autojs manager | jslead otro |
    And I logout
    ...
    And I modify the employee with public data
      ...
      | TestAddress | test@hotmail.com | 456-158-15532 | 12      | 707-642-51545 | A224        | Cochabamba | Henry56  | 0F       | Bolivia | Other info |
    ...
    And I verify if he has this simple data in personal information
      | nationalOrForeign | idNumber | idExpDate  | idPlace | passportNumber | passportPlace | passportExpDate | hasVisa | visaType                       | visaExpDate | homeAddressDescription                                              | dateBirth  | age | country | city     |
      | National          | 6454215  | 02/22/2017 | CBA     | 4564215        | Angola        | 02/20/2019      | true    | Business and Tourism (B-1/B-2) | 02/20/2019  | C. Tarata<br>Tarata CBA 123<br>Bolivia<br>17°21'57.9"S 66°10'32.0"W | 02/12/1986 | 30  | Albania | SomeCity |
  ...
  Scenario Outline: Verify that employee fields are edited with admin role
    ...
    And I modify the employee with engineering data
      ...
      | IT         | Support  | Security | autojs manager | jslead otro | false      | true   | true       | false | ders   | 02/03/2016   | 02/03/2017   |
