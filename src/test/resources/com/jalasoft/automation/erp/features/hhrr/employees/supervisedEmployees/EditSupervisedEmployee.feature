...
Feature: Edit supervised employees
  ...
  Scenario Outline: Verify that employee fields are edited with admin role
    ...
    When I modify the employee with basic data
      ...
      And I modify the employee with engineering data
        ...
        | IT         | Support  | Security | auto srmanager hr | auto manager hr | false   | true     | Risk           | dwe   | true       | 02/03/2016    | true   | true       | false | ders   | 02/03/2016   | 02/03/2017   |
  ...
  Scenario Outline: Verify that employee fields are edited with staffing role
    ...
    When I create an employee with required fields
      ...
      | auto      | edit<number> | Henry56 | 6454215  | auto manager hr | auto lead hr |
    And I logout
    And I login with "<role>" credentials
    And I go to "employees" hhrr submenu
    And I select "list" view
    ...
    And I verify if he has this data in public information
      | workEmail        | workPhone     | extCode | workMobile    | user     | otherInfo  | location | codeDesktop | country | city       |
      | test@hotmail.com | 456-158-15532 | 12      | 707-642-51545 | Henry56  | Other info | 0F       | A224        | Bolivia | Cochabamba |
  ...
  Scenario Outline: Verify that employee fields are edited with srmanager role
    ...
    Then I verify if he has this data in basic information
      ...
      And I verify if he has this simple data in engineering information
        | department | division | jobTitle | manager           | lead            | visible | billable | shadowCategory | notes | commitment | expDateCommit | active | consultant | jce   | reason | lastEvalDate | nextEvalDate |
        | IT         | Support  | Security | auto srmanager hr | auto manager hr | false   | false    |                |       | true       | 02/03/2016    | true   | true       | false | ders   | 02/03/2016   | 02/03/2017   |
      And I verify if he has this other supervisors data
        | name          |
        | auto admin hr |
  ...
  @EditEmployeeInformation @CRUD @all @This
  Scenario Outline: Verify that employee fields are edited with personnel admin role
    Bugs: HBH35[REG] Staffing fields were removed from Edit steps and empty for Read steps due to access denied message(Pending to review on meeting)
    Given I navigate to login page
      And I login with "admin" credentials
    When I create an employee with required fields
      | firstName | lastName     | idNumber | manager         | lead         |
  ...
  Scenario Outline: Verify that employee fields are edited with lead role
    ...
    When I press "edit" general button
      ...
      And I modify the employee with engineering data
        | department | division | jobTitle | commitment | expDateCommit | active | consultant | jce   | reason | lastEvalDate | nextEvalDate |
        | IT         | Support  | Security | true       | 02/03/2016    | true   | true       | false | ders   | 02/03/2016   | 02/03/2017   |
    ...
    Then I verify if he has this data in basic information
      ...
      And I verify if he has this simple data in engineering information
        | department | division | jobTitle | visible | billable | shadowCategory | notes | commitment | expDateCommit | active | consultant | jce   | reason | lastEvalDate | nextEvalDate |
        | IT         | Support  | Security | false   | false    |                |       | true       | 02/03/2016    | true   | true       | false | ders   | 02/03/2016   | 02/03/2017   |
